...
const FetchSOS = () => {
    ...
    const fetch = firebase.firestore().collection("SOS");

    const [users2,setUsers2] = useState([]);

    const fetch2 = firebase.firestore().collection("newData");
    ...
    useEffect(() =>{
        fetch2.onSnapshot(querySnapShot => {
            const users2 = []
